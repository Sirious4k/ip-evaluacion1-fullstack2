...
function SignUp() {
    ...
    const styles = {
        mainStyle: 'flex items-center justify-center min-h-[100vh] !mt-0 !py-8 main-style  gradient-main ',

        boxSignUp: 'flex flex-col max-h-auto md:max-w-[500px] md:w-[500px] w-full   p-8 bg-[var(--white-variant)] shadow-2xl'
    }
