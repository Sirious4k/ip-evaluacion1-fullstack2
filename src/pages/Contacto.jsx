...
function Contacto() {
    ...
    const containerStyles = {
        ...
        boxContent: 'flex flex-col w-full h-auto p-[50px] gap-[20px] bg-[var(--bg-secondary)]/30'
    }
    ...
    const formStyles = {
        ...
        textArea: 'h-full bg-inherit border border-[var(--hover-alt)]/20 transition-border duration-300 ease-in-out outline-hidden resize-none p-[20px] format-text-p !not-italic !text-left focus:border-[var(--hover-alt)]/90 scrollbar-thin',
